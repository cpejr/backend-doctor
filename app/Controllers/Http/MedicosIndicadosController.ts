...
public async index({ request }: HttpContextContract) {
    ...
    const medicos_indicados = await MedicosIndicadoRepository.find(limpaCamposNulosDeObjeto(indicacaoMedico))
...
public async indexByIdIndicacao({ request }: HttpContextContract) {
    ...
    const consultas = MedicosIndicadoRepository.find(limpaCamposNulosDeObjeto(medico_indicado))
